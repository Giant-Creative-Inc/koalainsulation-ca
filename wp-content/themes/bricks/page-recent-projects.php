...
// --- Drop-in replacement for /recent-projects routing + correct HTTP status ---
...
// Supported patterns:
//   /ca/{location}/recent-projects
//   /{location}/recent-projects
//   /recent-projects (generic)
$idx = array_search('recent-projects', $parts, true);
if ($idx === false) {
...
if ($location_slug) {
    ...
    // Generic /recent-projects (no location segment) → still a 200
    global $wp_query;
    if ($wp_query) {
        $wp_query->is_404 = false;
        $wp_query->is_page = true;
