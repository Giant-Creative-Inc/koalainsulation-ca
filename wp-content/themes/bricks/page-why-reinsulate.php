...
// Supported patterns:
//   /ca/{location}/why-reinsulate
//   /{location}/why-reinsulate
//   /why-reinsulate  (generic)
$idx = array_search('why-reinsulate', $parts, true);
if ($idx === false) {
...
if ($location_slug) {
    ...
    // Generic /why-reinsulate (no location segment) → still a 200
    global $wp_query;
    if ($wp_query) {
        $wp_query->is_404 = false;
        $wp_query->is_page = true;
                                            ...
                                            <div id="brxe-rvetlo" class="brxe-block bricks-lazy-hidden">
                                                ...
                                                <div id="brxe-ahgamh" class="brxe-text">
                                                    <p>
                                                        ...
                                                        cooling. On average, homeowners save 20% on energy costs
                                            ...
                                            <div id="brxe-videvv" class="brxe-block bricks-lazy-hidden">
                                                ...
                                                <div id="brxe-ynrjxx" class="brxe-text">
                                                    <p>
                                                        ...
                                                        fibreglass batt insulation, not only makes your home more
                                        ...
                                        <div id="brxe-kkpqwk" class="brxe-block tab-pane bricks-lazy-hidden">
                                            ...
                                            <div id="brxe-qnmvhe" class="brxe-block bricks-lazy-hidden">
                                                ...
                                                <div id="brxe-yghxni" class="brxe-text">
                                                    Upgrading your insulation is not only great for the environment, but can save
                                            ...
                                            <div id="brxe-lrhwzu" class="brxe-block bricks-lazy-hidden">
                                                <div id="brxe-dmesfi" class="brxe-block bricks-lazy-hidden">
                                                    <img width="1024" height="822"
                                                        ...
                                                        data-src="<?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21-1024x822.jpg'); ?>"
                                                        data-type="string" data-sizes="(max-width: 1024px) 100vw, 1024px"
                                                        data-srcset="<?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21-1024x822.jpg'); ?> 1024w, <?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21-300x241.jpg'); ?> 300w, <?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21-768x616.jpg'); ?> 768w, <?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21-1536x1233.jpg'); ?> 1536w, <?php echo home_url('/wp-content/uploads/2025/07/ed5fe07b-af75-4771-af02-8624f1f4ff21.jpg'); ?> 2048w" />
                                                </div>
                                            </div>
                                ...
                                <div id="brxe-ergqvd" class="brxe-block hero_content-wrapper" data-animation="up"
                                    ...
                                    <div id="brxe-jvmaaz" class="brxe-block">
                                        ...
                                        <div id="brxe-bnexob" class="brxe-text-basic text-size-regular text-color-mute"
                                            data-animi="up" data-duration="0.6" data-delay="0.2">
                                            Homeowners can benefit from several regional, provincial, and federal incentives. Here
                    ...
                    <div id="brxe-ofjvfk" class="brxe-block brx-grid hero-block-grid">
                        <div id="brxe-ergqvd" class="brxe-block hero_content-wrapper" data-animation="up"
                            ...
                            <div id="brxe-jvmaaz" class="brxe-block">
                                ...
                                <a href="/ca/homeowner-incentives" class="brxe-jvgelr brxe-div btn-secondary"
                                    data-animi="up" data-duration="0.6" data-delay="0.3">
                                    <div class="brxe-nahywj brxe-text-basic">Read More</div>
                                </a>
                            </div>
