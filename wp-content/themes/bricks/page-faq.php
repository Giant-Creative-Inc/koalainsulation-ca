...
if (count($segments) === 3 && $segments[2] === 'faq') {
    ...
    // ✅Tell WP this is a real page and bind the location as queried object
...
} elseif (count($segments) === 2 && $segments[1] === 'faq') {
    // Generic FAQ page under /ca/faq (or /faq if you're not using /ca/)
    global $wp_query;
    if ($wp_query) {
        $wp_query->is_404 = false;
        $wp_query->is_page = true;
