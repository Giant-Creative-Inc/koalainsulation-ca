...
// Supported patterns:
//   /ca/{location}/why-koala
//   /{location}/why-koala
//   /why-koala  (generic)
$idx = array_search('why-koala', $parts, true);
if ($idx === false) {
...
if ($location_slug) {
    ...
    // Generic /why-koala (no location segment) → still a 200
    global $wp_query;
    if ($wp_query) {
        $wp_query->is_404 = false;
        $wp_query->is_page = true;
...
if ($location) {
    ...
    $args = array(
        'post_type' => 'location-why-koala', // The custom post type slug for "Why Koala"
        'posts_per_page' => -1, // Show all posts
        'meta_query' => array(
            array(
                'key' => 'wk_related_location', // The ACF relationship field key in "Why Koala"
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            ...
            // Get related services from the 'wk_related_services' field
            ...
            <main id="brx-content">
                ...
                " />
                                ...
                                <div id="brxe-oqfivt" class="brxe-block hero_image-wrapper">
                                    <?php
                                    ...
                                    if ($heroImage) {
                                        ...
                                        <img width="1005" height="1024"
                                            src="<?php echo home_url('/wp-content/uploads/2025/03/Handshake-scaled-1.jpg'); ?>"
                                            class="brxe-image image-cover css-filter size-large" alt="Customer shaking hands with Koala Insulation Canada employee"
                                            id="brxe-ozcdgq" />
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <div class="brxe-div acc-container3">
                                        ...
                                        <div class="brxe-block acc3">
                                            ...
                                            <div class="brxe-block acc-content3 accordion-content-wrapper">
                                                <div class="brxe-text accordian-text">
                                                    <p>
                                                        With over 67,000 insulation jobs completed, we bring a
                            ...
                            <div id="brxe-uiiuve" class="brxe-block section-component">
                                <div id="brxe-zfpkbx" class="brxe-block" data-animi="up" data-delay="0.1">
                                    <div id="brxe-zswths" class="brxe-block">
                                        ...
                                        <div id="brxe-tmynax" class="brxe-text-basic" data-animi="up" data-duration="0.6">
                                    ...
                                    <div class="brxe-div acc-container3">
                                        <div class="brxe-block acc3">
                                            ...
                                            <div class="brxe-block acc-content3 accordion-content-wrapper">
                                                <div class="brxe-text accordian-text">
                                                    <p>
                                                        Customers often see up to a 20% reduction in energy bills* thanks to
                                            ...
                                            <div class="brxe-block acc-content3 accordion-content-wrapper">
                                                <div class="brxe-text accordian-text">
                                                    <p>
                                                        ...
                                                        sealing and crawl space insulation.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="brxe-zxqbto" class="brxe-div swiper-wrapper">
                                                <?php if ($related_services): ?>
                                                    <?php foreach ($related_services as $service): ?>
                                                        ...
                                                        $service_image = get_field('location_service_image', $service_id);
                        ...
                        <div id="brxe-etcewf" class="brxe-block">
                            <div id="brxe-onytvi" class="brxe-block">
                                ...
                                <div id="brxe-cvthkj" class="brxe-text-basic text-size-regular text-weight-semibold" text-split=""
                                    lines-slide-up="" style="opacity: 1">
...
function render_fallback_content()
{
    ...
    <main id="brx-content">
        <section id="brxe-ldroab" class="brxe-section section">
            <div id="brxe-iygybc" class="brxe-container padding-global">
                ...
                " />
                        ...
                        <div id="brxe-oqfivt" class="brxe-block hero_image-wrapper">
                            <img width="1005" height="1024"
                                src="<?php echo home_url('/wp-content/uploads/2024/12/KW-Team.jpg'); ?>"
                                class="brxe-image image-cover css-filter size-large" alt="Why Koala Hero Image"
                                id="brxe-ozcdgq" />
                        </div>
                    </div>
                                    ...
                                    <div class="brxe-block acc-head3 accordion-title-wrapper">
                                        <div class="brxe-block acc3-head-inner">
                                            <img width="54" height="55"
                                                ...
                                                decoding="async" data-type="string" />
                                            <div class="brxe-text-basic accordian-title">
                                                #1 Insulation Company in North America
                                            </div>
                                        </div>
                                        <div class="brxe-div accordian-icon-wrapper">
                                            <img src="<?php echo home_url('/wp-content/uploads/2024/09/Frame-1.svg'); ?>"
        ...
        <section id="cta-quote" class="brxe-section section" style="display: flex; visibility: visible">
            <div id="brxe-cqllpo" class="brxe-block section-component">
                <div id="brxe-etcewf" class="brxe-block">
                    <div id="brxe-onytvi" class="brxe-block">
                        <h2 id="brxe-olzjbf" class="brxe-heading heading-style-h2 font-weight-bold text-allcaps"
